package eu.kanade.tachiyomi.extension.pt.hentaihq
...
class HentaiHq(
    ...
    override val name = "HentaiHq"
    override val baseUrl = "https://hentaihq.net"
    ...
    override fun popularMangaParse(response: Response): MangasPage {
        ...
        for (i in 0 until jsonArray.length()) {
            ...
            if (!link.contains("hentaihq.net")) continue
