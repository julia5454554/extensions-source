package eu.kanade.tachiyomi.extension.pt.superhentaiblog
...
@Source
class SuperHentaiBlog(
    override val lang: String = "pt-BR",
    override val id: Long = 0L, // troque por um ID único na publicação
) : HttpSource() {

    override val name = "SuperHentaiBlog"
    override val baseUrl = "https://superhentai.blog"
    ...
    override fun popularMangaParse(response: Response): MangasPage {
        ...
        for (i in 0 until jsonArray.length()) {
            ...
            if (!link.contains("superhentai.blog")) continue
